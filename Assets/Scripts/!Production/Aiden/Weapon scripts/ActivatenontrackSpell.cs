...
public class ActivatenontrackSpell : MonoBehaviour {
        ...
        if (Leftactive == true)
        {
            if (OVRInput.Get(OVRInput.Axis1D.PrimaryIndexTrigger) <= 0.5f)
            {
                if (OVRInput.Get(OVRInput.Touch.PrimaryThumbRest) == false)
                {
                    if (Sticky == true)
                    {
                        recentspellLeft = Instantiate(Spell, CurrentactiveL.transform.position, CurrentactiveL.transform.rotation, lefthand.transform);
                    }
                    else
                    {
        ...
        if (Rightactive == true)
        {
            if (OVRInput.Get(OVRInput.Axis1D.SecondaryIndexTrigger) <= 0.5f)
            {
                if (OVRInput.Get(OVRInput.Touch.SecondaryThumbRest) == false)
                {
                    if (Sticky == true)
                    {
                        recentspellRight = Instantiate(Spell, CurrentactiveR.transform.position, CurrentactiveR.transform.rotation, righthand.transform);
                    }
                    else
                    {
